...
class FileDescriptor
{
    ...
    public static function buildFromProto($proto, $custom_json_names = [])
    {
        ...
        foreach ($proto->getMessageType() as $message_proto) {
            $file->addMessageType(\Google\Protobuf\Internal\Descriptor::buildFromProto($message_proto, $proto, "", $custom_json_names));
        }
        foreach ($proto->getEnumType() as $enum_proto) {
            $file->addEnumType(\Google\Protobuf\Internal\EnumDescriptor::buildFromProto($enum_proto, $proto, "", $custom_json_names));
        }
        return $file;
    }
}
