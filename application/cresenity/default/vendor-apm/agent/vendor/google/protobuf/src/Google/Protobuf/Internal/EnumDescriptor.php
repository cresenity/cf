...
class EnumDescriptor
{
     ...
     */
    public function addValue(\Google\Protobuf\Internal\EnumValueDescriptor $value)
    {
    ...
    public static function buildFromProto($proto, $file_proto, $containing, $custom_json_names = [])
    {
        ...
        foreach ($values as $value) {
            ...
            $desc->addValue(new \Google\Protobuf\Internal\EnumValueDescriptor($value->getName(), $value->getNumber(), $custom_json_name));
        }
        return $desc;
    }
}
