...
namespace CresenityDevCloudAPMVendor\Http\Discovery;

use CresenityDevCloudAPMVendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use CresenityDevCloudAPMVendor\Http\Discovery\Exception\DiscoveryFailedException;
use CresenityDevCloudAPMVendor\Http\Discovery\Exception\NoCandidateFoundException;
use CresenityDevCloudAPMVendor\Http\Discovery\Exception\StrategyUnavailableException;
use CresenityDevCloudAPMVendor\Http\Discovery\Strategy\DiscoveryStrategy;
/**
