...
namespace CresenityDevCloudAPMVendor\Http\Discovery\Composer;

use CresenityDevCloudAPMVendor\Composer\Composer;
use CresenityDevCloudAPMVendor\Composer\DependencyResolver\Pool;
use CresenityDevCloudAPMVendor\Composer\EventDispatcher\EventSubscriberInterface;
use CresenityDevCloudAPMVendor\Composer\Factory;
use CresenityDevCloudAPMVendor\Composer\Installer;
use CresenityDevCloudAPMVendor\Composer\IO\IOInterface;
use CresenityDevCloudAPMVendor\Composer\Json\JsonFile;
use CresenityDevCloudAPMVendor\Composer\Json\JsonManipulator;
use CresenityDevCloudAPMVendor\Composer\Package\Locker;
use CresenityDevCloudAPMVendor\Composer\Package\Version\VersionParser;
use CresenityDevCloudAPMVendor\Composer\Package\Version\VersionSelector;
use CresenityDevCloudAPMVendor\Composer\Plugin\PluginInterface;
use CresenityDevCloudAPMVendor\Composer\Repository\InstalledRepositoryInterface;
use CresenityDevCloudAPMVendor\Composer\Repository\RepositorySet;
use CresenityDevCloudAPMVendor\Composer\Script\Event;
use CresenityDevCloudAPMVendor\Composer\Script\ScriptEvents;
use CresenityDevCloudAPMVendor\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['CresenityDevCloudAPMVendor\Http\Client\HttpAsyncClient'], 'php-http/client-implementation' => ['CresenityDevCloudAPMVendor\Http\Client\HttpClient'], 'psr/http-client-implementation' => ['CresenityDevCloudAPMVendor\Psr\Http\Client\ClientInterface'], 'psr/http-factory-implementation' => ['CresenityDevCloudAPMVendor\Psr\Http\Message\RequestFactoryInterface', 'CresenityDevCloudAPMVendor\Psr\Http\Message\ResponseFactoryInterface', 'CresenityDevCloudAPMVendor\Psr\Http\Message\ServerRequestFactoryInterface', 'CresenityDevCloudAPMVendor\Psr\Http\Message\StreamFactoryInterface', 'CresenityDevCloudAPMVendor\Psr\Http\Message\UploadedFileFactoryInterface', 'CresenityDevCloudAPMVendor\Psr\Http\Message\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions): array
    {
        ...
        if (ClassDiscovery::safeClassExists(\CresenityDevCloudAPMVendor\Phalcon\Http\Message\RequestFactory::class, \false)) {
