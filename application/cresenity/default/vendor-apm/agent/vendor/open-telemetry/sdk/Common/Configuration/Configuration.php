...
namespace CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Configuration;

use InvalidArgumentException;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Behavior\LogsMessagesTrait;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Configuration\Parser\BooleanParser;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Configuration\Parser\ListParser;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Configuration\Parser\MapParser;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Configuration\Parser\RatioParser;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Configuration\Resolver\CompositeResolver;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Util\ClassConstantAccessor;
...
class Configuration
{
    ...
    {
        return (float) self::validateVariableValue(CompositeResolver::instance()->resolve(self::validateVariableType($key, VariableTypes::FLOAT), $default), \FILTER_VALIDATE_FLOAT);
    }
