...
final class SynchronousMetricStream implements MetricStreamInterface
{
     ...
     */
    public function __construct(private readonly AggregationInterface $aggregation, private int $timestamp)
    {
    ...
    public function collect(int $reader): DataInterface
    {
        ...
        return $this->aggregation->toData($metric->attributes, $metric->summaries, Exemplar::groupByIndex($metric->exemplars), $metric->timestamp, $this->timestamp, $temporality);
    }
}
