...
use CresenityDevCloudAPMVendor\Psr\Log\InvalidArgumentException;
use CresenityDevCloudAPMVendor\Psr\Log\LoggerInterface;
use CresenityDevCloudAPMVendor\Psr\Log\LoggerTrait;
...
class SimplePsrFileLogger implements LoggerInterface
{
    ...
    public function __construct(private readonly string $filename, private readonly string $loggerName = self::DEFAULT_LOGGER_NAME)
    {
    }
    /**
    ...
    public function log($level, $message, array $context = []): void
    {
        ...
        if (!in_array($level, self::getLogLevels(), \true)) {
