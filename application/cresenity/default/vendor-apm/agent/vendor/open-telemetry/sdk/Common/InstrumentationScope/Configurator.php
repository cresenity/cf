...
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Logs\LoggerConfig;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Metrics\MeterConfig;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Trace\TracerConfig;
use WeakMap;
/**
 * @template T
 */
