...
final class SamplingResult
{
     ...
     */
    public function __construct(private readonly int $decision, private readonly iterable $attributes = [], private readonly ?API\TraceStateInterface $traceState = null)
    {
    }
    /**
