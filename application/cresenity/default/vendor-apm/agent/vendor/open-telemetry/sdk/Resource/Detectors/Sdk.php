...
use CresenityDevCloudAPMVendor\OpenTelemetry\SemConv\Attributes\TelemetryAttributes;
use CresenityDevCloudAPMVendor\OpenTelemetry\SemConv\Incubating\Attributes\TelemetryIncubatingAttributes;
...
{
    private const PACKAGES = ['open-telemetry/sdk', 'open-telemetry/opentelemetry'];
    #[\Override]
    public function getResource(): ResourceInfo
    {
        $attributes = [TelemetryAttributes::TELEMETRY_SDK_NAME => 'opentelemetry', TelemetryAttributes::TELEMETRY_SDK_LANGUAGE => 'php'];
