...
{
    public function __construct(private readonly int|string $index, public readonly float|int $value, public readonly int $timestamp, public readonly AttributesInterface $attributes, public readonly ?string $traceId, public readonly ?string $spanId)
    {
    }
    /**
