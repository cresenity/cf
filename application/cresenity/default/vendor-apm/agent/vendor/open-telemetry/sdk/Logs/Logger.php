...
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Logs\LogRecordBuilderInterface;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Logs\NoopLogRecordBuilder;
...
class Logger implements LoggerInterface
{
     ...
     */
    public function __construct(private readonly LoggerSharedState $loggerSharedState, private readonly InstrumentationScopeInterface $scope, ?Configurator $configurator = null)
    {
