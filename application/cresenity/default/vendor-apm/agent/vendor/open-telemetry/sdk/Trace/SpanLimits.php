...
final class SpanLimits
{
     ...
     */
    public function __construct(private readonly AttributesFactoryInterface $attributesFactory, private readonly AttributesFactoryInterface $eventAttributesFactory, private readonly AttributesFactoryInterface $linkAttributesFactory, private readonly int $eventCountLimit, private readonly int $linkCountLimit)
    {
    }
}
