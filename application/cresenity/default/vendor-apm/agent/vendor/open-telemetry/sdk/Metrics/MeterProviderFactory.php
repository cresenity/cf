...
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Metrics\Exemplar\ExemplarFilter\AllExemplarFilter;
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Metrics\Exemplar\ExemplarFilter\NoneExemplarFilter;
...
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Metrics\MetricExporter\NoopMetricExporter;
...
class MeterProviderFactory
{
    ...
    public function create(?ResourceInfo $resource = null): MeterProviderInterface
    {
        ...
        return MeterProvider::builder()->setResource($resource)->addReader($reader)->setExemplarFilter($exemplarFilter)->build();
    }
