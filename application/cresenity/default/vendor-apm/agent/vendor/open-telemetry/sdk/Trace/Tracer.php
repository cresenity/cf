...
class Tracer implements API\TracerInterface
{
    ...
    public function __construct(private readonly TracerSharedState $tracerSharedState, private readonly InstrumentationScopeInterface $instrumentationScope, ?Configurator $configurator = null, private readonly SpanSuppressor $spanSuppressor = new NoopSuppressor())
    {
    ...
    public function spanBuilder(string $spanName): API\SpanBuilderInterface
    {
        ...
        return new SpanBuilder($spanName, $this->instrumentationScope, $this->tracerSharedState, $this->spanSuppressor);
    }
