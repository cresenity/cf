...
final class TracerProviderFactory
{
    ...
    public function __construct(private readonly ExporterFactory $exporterFactory = new ExporterFactory(), private readonly SamplerFactory $samplerFactory = new SamplerFactory(), private readonly SpanProcessorFactory $spanProcessorFactory = new SpanProcessorFactory())
    {
    }
    public function create(?MeterProviderInterface $meterProvider = null): TracerProviderInterface
    {
        ...
        return new TracerProvider($spanProcessor, $sampler, meterProvider: $meterProvider);
    }
}
