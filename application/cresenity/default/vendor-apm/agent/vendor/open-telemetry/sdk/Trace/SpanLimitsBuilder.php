...
class SpanLimitsBuilder
{
    ...
    public function build(): SpanLimits
    {
        ...
        return new SpanLimits(Attributes::factory($attributeCountLimit, $attributeValueLengthLimit), Attributes::factory($attributePerEventCountLimit, $attributeValueLengthLimit), Attributes::factory($attributePerLinkCountLimit, $attributeValueLengthLimit), $eventCountLimit, $linkCountLimit);
    }
}
