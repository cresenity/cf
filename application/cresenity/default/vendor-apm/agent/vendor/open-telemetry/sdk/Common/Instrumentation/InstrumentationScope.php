...
{
    public function __construct(private readonly string $name, private readonly ?string $version, private readonly ?string $schemaUrl, private readonly AttributesInterface $attributes)
    {
    }
    #[\Override]
