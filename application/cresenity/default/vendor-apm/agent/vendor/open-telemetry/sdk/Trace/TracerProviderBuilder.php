...
class TracerProviderBuilder
{
    ...
    {
        return new TracerProvider($this->spanProcessors, $this->sampler, $this->resource, configurator: $this->configurator ?? Configurator::tracer(), spanSuppressionStrategy: $this->spanSuppressionStrategy ?? new NoopSuppressionStrategy(), meterProvider: $this->meterProvider);
    }
}
