...
class LoggerSharedState
{
    ...
    public function __construct(private readonly ResourceInfo $resource, private readonly LogRecordLimits $limits, private readonly LogRecordProcessorInterface $processor, ?MeterProviderInterface $meterProvider = null)
    {
        if ($meterProvider !== null) {
            $this->logCreatedCounter = $meterProvider->getMeter('io.opentelemetry.sdk', schemaUrl: Version::VERSION_1_36_0->url())->createCounter(OtelIncubatingMetrics::OTEL_SDK_LOG_CREATED, '{log_record}', 'The number of logs submitted to enabled SDK Loggers');
        } else {
