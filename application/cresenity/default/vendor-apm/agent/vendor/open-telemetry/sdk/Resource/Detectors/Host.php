...
use CresenityDevCloudAPMVendor\OpenTelemetry\SemConv\Incubating\Attributes\HostIncubatingAttributes;
use CresenityDevCloudAPMVendor\OpenTelemetry\SemConv\Incubating\Attributes\OsIncubatingAttributes;
...
final class Host implements ResourceDetectorInterface
{
    ...
    public function __construct(private readonly string $dir = '/', private readonly string $os = PHP_OS_FAMILY)
    {
    }
    #[\Override]
    public function getResource(): ResourceInfo
    {
        $attributes = [HostIncubatingAttributes::HOST_NAME => php_uname('n'), HostIncubatingAttributes::HOST_ARCH => php_uname('m'), HostIncubatingAttributes::HOST_ID => $this->getMachineId(), OsIncubatingAttributes::OS_TYPE => strtolower(PHP_OS_FAMILY), OsIncubatingAttributes::OS_DESCRIPTION => php_uname('r'), OsIncubatingAttributes::OS_NAME => PHP_OS, OsIncubatingAttributes::OS_VERSION => php_uname('v')];
    ...
    {
        set_error_handler(static fn() => \true);
        try {
