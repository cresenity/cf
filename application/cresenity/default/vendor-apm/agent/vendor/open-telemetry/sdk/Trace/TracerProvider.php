...
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\NoopTracer;
...
use CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Trace\Sampler\AlwaysOnSampler;
...
final class TracerProvider implements TracerProviderInterface
{
    ...
    public function __construct(SpanProcessorInterface|array|null $spanProcessors = [], ?SamplerInterface $sampler = null, ?ResourceInfo $resource = null, ?SpanLimits $spanLimits = null, ?IdGeneratorInterface $idGenerator = null, ?InstrumentationScopeFactoryInterface $instrumentationScopeFactory = null, private ?Configurator $configurator = null, private readonly SpanSuppressionStrategy $spanSuppressionStrategy = new NoopSuppressionStrategy(), ?MeterProviderInterface $meterProvider = null)
    {
        $spanProcessors ??= [];
        ...
        $this->tracerSharedState = new TracerSharedState($idGenerator, $resource, $spanLimits, $sampler, $spanProcessors, $meterProvider);
    ...
    public function getTracer(string $name, ?string $version = null, ?string $schemaUrl = null, iterable $attributes = []): API\TracerInterface
    {
        ...
        $tracer = new Tracer($this->tracerSharedState, $scope, $this->configurator, $this->spanSuppressionStrategy->getSuppressor($name, $version, $schemaUrl));
