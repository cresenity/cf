...
namespace CresenityDevCloudAPMVendor\OpenTelemetry\SDK\Common\Export\Stream;
...
final class StreamTransport implements TransportInterface
{
     ...
     */
    public function __construct(private $stream, private readonly string $contentType)
    {
    }
    #[\Override]
