...
namespace CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\Propagation;

use function count;
use function explode;
use function hexdec;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\Span;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\SpanContext;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\SpanContextInterface;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\SpanContextValidator;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\TraceFlags;
use CresenityDevCloudAPMVendor\OpenTelemetry\API\Trace\TraceState;
...
use CresenityDevCloudAPMVendor\OpenTelemetry\Context\Propagation\ArrayAccessGetterSetter;
...
final class TraceContextPropagator implements TextMapPropagatorInterface
{
    ...
    public function inject(&$carrier, ?PropagationSetterInterface $setter = null, ?ContextInterface $context = null): void
    {
        ...
        $traceparent = sprintf('%02x-%s-%s-%02x', self::VERSION, $spanContext->getTraceId(), $spanContext->getSpanId(), $spanContext->getTraceFlags() & self::SUPPORTED_FLAGS);
    ...
    private static function extractImpl($carrier, PropagationGetterInterface $getter): SpanContextInterface
    {
        ...
        return SpanContext::createFromRemoteParent($traceId, $spanId, hexdec($traceFlags) & self::SUPPORTED_FLAGS, $tracestate);
    }
}
