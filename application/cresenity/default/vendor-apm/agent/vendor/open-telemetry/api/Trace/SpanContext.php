...
final class SpanContext implements SpanContextInterface
{
    ...
    private function __construct(private string $traceId, private string $spanId, private readonly int $traceFlags, private readonly bool $isRemote, private readonly ?TraceStateInterface $traceState = null)
    {
