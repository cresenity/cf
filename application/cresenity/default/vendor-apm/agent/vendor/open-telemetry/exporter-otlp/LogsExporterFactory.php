...
class LogsExporterFactory implements LogRecordExporterFactoryInterface
{
    ...
    {
        return Configuration::has(Variables::OTEL_EXPORTER_OTLP_LOGS_COMPRESSION) ? Configuration::getEnum(Variables::OTEL_EXPORTER_OTLP_LOGS_COMPRESSION) : Configuration::getEnum(Variables::OTEL_EXPORTER_OTLP_COMPRESSION, self::DEFAULT_COMPRESSION);
    }
    ...
    {
        $value = Configuration::has(Variables::OTEL_EXPORTER_OTLP_LOGS_TIMEOUT) ? Configuration::getInt(Variables::OTEL_EXPORTER_OTLP_LOGS_TIMEOUT) : Configuration::getInt(Variables::OTEL_EXPORTER_OTLP_TIMEOUT);
        return $value / 1000;
    }
}
