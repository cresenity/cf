...
interface HttpEndpointResolverInterface
{
    ...
    public const DEFAULT_PATHS = [Signals::TRACE => self::TRACE_DEFAULT_PATH, Signals::METRICS => self::METRICS_DEFAULT_PATH, Signals::LOGS => self::LOGS_DEFAULT_PATH];
    public const VALID_SCHEMES = ['http', 'https'];
