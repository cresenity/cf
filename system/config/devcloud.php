...
return [
    ...
    | v1/jsExceptions endpoint, cross-origin - not through this app's own PHP
    | at all. CApp's RendererTrait (classic pages) and each SPA's own shell
    | inject `url`/`key` below into `window.__CF_JS_COLLECTOR_CONFIG__` for
    | the package to read.
    |
