...
class CCache_Lock_DatabaseLock extends CCache_LockAbstract {
    /**
    ...
    protected function expiresAt() {
        return $this->seconds > 0 ? time() + $this->seconds : CCarbon::now()->addDays(1)->getTimestamp();
    }
    ...
    protected function getCurrentOwner() {
        return c::optional($this->connection->table($this->table)->where('key', $this->name)->first())->owner;
    }
