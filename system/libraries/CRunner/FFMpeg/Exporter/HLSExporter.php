...
class CRunner_FFMpeg_Exporter_HLSExporter extends CRunner_FFMpeg_Exporter_MediaExporter {
     ...
     *
     * @param \CRunner_FFMpeg_Exporter_PlaylistGeneratorInterface $playlistGenerator
     *
     * @return self
     */
    public function withPlaylistGenerator(CRunner_FFMpeg_Exporter_PlaylistGeneratorInterface $playlistGenerator) {
        $this->playlistGenerator = $playlistGenerator;

        return $this;
    }

    private function getPlaylistGenerator() {
