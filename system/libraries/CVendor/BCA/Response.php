<?php
class CVendor_BCA_Response implements ArrayAccess {
     ...
     *
     * @return null|\CVendor_BCA_Exception_RequestException
     */
    public function toException() {
        if ($this->failed()) {
            return new CVendor_BCA_Exception_RequestException($this);
        }
    }
