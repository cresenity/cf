...
class CParser_Dom_HtmlPageCrawler extends Crawler {
     ...
     *
     * @param string|CParser_Dom_HtmlPageCrawler|\DOMNode|\DOMNodeList|array $content
     *
    ...
    public static function create($content) {
        if ($content instanceof CParser_Dom_HtmlPageCrawler) {
            return $content;
        } else {
            return new CParser_Dom_HtmlPageCrawler($content);
        }
    }
     ...
     *
     * @return CParser_Dom_HtmlPageCrawler $this for chaining
     *
     * @api
     */
     ...
     *
     * @param string|CParser_Dom_HtmlPageCrawler|\DOMNode|\DOMNodeList $content
     *
     * @return CParser_Dom_HtmlPageCrawler $this for chaining
     *
     * @api
     ...
     *
     * @param string|CParser_Dom_HtmlPageCrawler|\DOMNode|\DOMNodeList $content HTML code fragment or DOMNode to append
     *
     * @return CParser_Dom_HtmlPageCrawler $this for chaining
     *
     * @api
     ...
     *
     * @param string|CParser_Dom_HtmlPageCrawler|\DOMNode|\DOMNodeList $element
     *
     * @return \CParser_Dom_HtmlPageCrawler A new Crawler object containing all elements appended to the target elements
     *
     * @api
     */
     ...
     *
     * @return null|string The attribute value or null if the attribute does not exist
     */
     ...
     *
     * @see CParser_Dom_HtmlPageCrawler::getStyle()
     * @see CParser_Dom_HtmlPageCrawler::setStyle()
     *
     ...
     *
     * @return CParser_Dom_HtmlPageCrawler|string If no param is provided, returns the CSS styles of the first element
     *
     * @api
     */
     ...
     *
     * @return null|string value of the property
     */
    public function getStyle($key) {
        $styles = CParser_Dom_Helpers::cssStringToArray($this->getAttribute('style'));
    ...
    public function setStyle($key, $value) {
        foreach ($this as $node) {
            if ($node instanceof \DOMElement) {
                /** @var \DOMElement $node */
                $styles = CParser_Dom_Helpers::cssStringToArray($node->getAttribute('style'));
                if ($value != '') {
                    $styles[$key] = $value;
                } elseif (isset($styles[$key])) {
                    unset($styles[$key]);
                }
                $node->setAttribute('style', CParser_Dom_Helpers::cssArrayToString($styles));
            }
        }
     ...
     * @param string|HtmlPageCrawler|\DOMNode|\DOMNodeList $element
     *
     * @return \CParser_Dom_HtmlPageCrawler A new Crawler object containing all elements prepended to the target elements
     *
     * @api
     */
    ...
    public function addHtmlFragment($content, $charset = 'UTF-8') {
        ...
        $bodynode = CParser_Dom_Helpers::getBodyNodeFromHtmlFragment($content, $charset);
