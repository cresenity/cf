...
/**
 * Description of CompileLayoutTrait
 */
trait CView_Compiler_BladeCompiler_CompileLayoutTrait {
    ...
    protected function compileExtends($expression) {
        ...
        $echo = "<?php echo \$__env->make({$expression}, carr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
    ...
    protected function compileExtendsFirst($expression) {
        ...
        $echo = "<?php echo \$__env->first({$expression}, carr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
