...
class CSession_Store implements CSession_Contract_SessionInterface {
    ...
    public function pull($key, $default = null) {
        return carr::pull($this->attributes, $key, $default);
    }
    ...
    public function getOldInput($key = null, $default = null) {
        return carr::get($this->get('_old_input', []), $key, $default);
    }
    ...
    public function put($key, $value = null) {
        ...
        foreach ($key as $arrayKey => $arrayValue) {
            carr::set($this->attributes, $arrayKey, $arrayValue);
        }
    }
    ...
    public function remove($key) {
        return carr::pull($this->attributes, $key);
    }
    ...
    public function regenerate($destroy = false) {
        return c::tap($this->migrate($destroy), function () {
            $this->regenerateToken();
        });
    }
    ...
    public function regenerateToken() {
        $this->put('_token', cstr::random(40));
    }
    ...
    public function handlerNeedsRequest() {
        return $this->handler instanceof CSession_Handler_CookieSessionHandler;
    }
